        ...
        <div className="flex min-h-screen">
            ...
            <div className="hidden lg:flex w-1/2 bg-blue-400 relative flex-col justify-center items-center overflow-hidden">
                ...
                <div className="z-10 text-center mb-8">
                    <h1 className="text-4xl font-bold text-white flex items-center justify-center gap-2">
                        <span className="bg-white text-blue-500 p-1 rounded">🛡️</span> DokTerKu
                    </h1>
                </div>
            ...
            <div className="flex-1 flex flex-col justify-center px-8 md:px-16 lg:px-24 bg-white relative">
                ...
                <div className="max-w-md w-full mx-auto">
                    <div className="mb-8">
                        <h2 className="text-3xl font-bold text-gray-900 mb-2">HI! Selamat Datang</h2>
                        <p className="text-gray-500">
                            Belum Daftar Akun? <Link href="/register" className="text-blue-500 hover:underline">Sign up</Link>
                        </p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1">NIK / No HP</label>
                            <input
                                type="text"
                                name="nik"
                                value={formData.nik}
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <input
                                    ...
                                    onChange={handleChange}
                                    placeholder="••••••••••••"
                                    className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition pr-10"
                                    required
                                />
                                <button
                                    type="button"
                        ...
                        <div className="flex items-center justify-between mt-4">
                            <label className="flex items-center gap-2 cursor-pointer">
                                <div className="relative flex items-center">
                                    <input type="checkbox" className="peer w-5 h-5 border-2 border-gray-300 rounded checked:bg-blue-500 checked:border-blue-500 transition" />
                                    <Check size={14} className="absolute text-white left-0.5 opacity-0 peer-checked:opacity-100 pointer-events-none" />
                                </div>
                                <span className="text-sm text-gray-600">Ingatkan aku</span>
                            </label>
                            <Link href="#" className="text-sm text-blue-500 hover:underline">Lupa Sandi?</Link>
                        </div>
                    </form>
